...
exports.allProducts = asyncErrorHandler(async (req, res, next) => {
...
exports.addProduct = asyncErrorHandler(async (req, res, next) => {
	...
	form.parse(req, async (err, field, files) => {
		let { name, category, description, stock, price, discount, brand, shopName } = field;
		const { images } = files;
...
exports.getSingleProductToAdmin = asyncErrorHandler(async (req, res, next) => {
	try {
...
exports.getHomeProducts = asyncErrorHandler(async (req, res, next) => {
...
exports.getProductQuery = asyncErrorHandler(async (req, res, next) => {
	const parPage = 16;
...
exports.getAllMyProductsSeller = asyncErrorHandler(async (req, res, next) => {
...
exports.getProductToEdit = asyncErrorHandler(async (req, res, next) => {
	const { productId } = req.params;
...
exports.getProductsByType = asyncErrorHandler(async (req, res, next) => {
