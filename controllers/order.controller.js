...
exports.placeNewOrder = asyncErrorHandler(async (req, res, next) => {
	const { products, items, shippingFee, price, shippingToAddress, userId, navigate } = req.body;
...
exports.getAllOrdersByStatus = asyncErrorHandler(async (req, res, next) => {
...
exports.getOrderDetail = asyncErrorHandler(async (req, res, next) => {
...
exports.customerOrderMake = asyncErrorHandler(async (req, res, next) => {
...
exports.getSellerOrders = asyncErrorHandler(async (req, res, next) => {
...
exports.getAdminOrders = asyncErrorHandler(async (req, res, next) => {
	let { page, search, parPage } = req.query;
	page = parseInt(page);
	parPage = parseInt(parPage);
	const skipPage = parPage * (page - 1);
